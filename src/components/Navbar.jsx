...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 shadow-md w-full px-10 z-50">
          ...
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => (
              <a
                key={index}
                href="#"
                className={`text-md capitalize font-[inter] font-bold text-zinc-600 hover:text-red-500 transition duration-300 ${
                  index === 4 ? "ml-45" : ""
                }`}
              >
                {item}
          ...
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => (
              <a
                key={index}
                href="#"
                className="block py-2 text-md font-[inter] font-bold text-zinc-600 hover:text-black transition duration-300"
              >
                {item}
              </a>
            )
